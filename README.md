...
テクニカルライター、プログラムマネージャー、またはプロダクトチームの開発者が[!UICONTROL Adobe Experience Cloud] ソリューションを使用しており、技術記事の投稿や作成を担当している場合は、`https://git.corp.adobe.com/AdobeDocs`のプライベートリポジトリを使用する必要があります。
