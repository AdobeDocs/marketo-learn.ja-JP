---
title: ウェビナープログラムの構築と運営について詳しく見る
description: マーケティング施策の一環としてウェビナーを開催する準備ができたら、  [!DNL Marketo Engage] とそのAdobe Exchange ウェビナーパートナーとのウェビナーの連携について説明します。
role: User
level: Beginner
jira: KT-10758
